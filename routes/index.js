...
const appointmentDomain =
  new (require("../domain/appointment").AppointmentDomain)(storage);
const waitingRoomDomain =
  new (require("../domain/waitingRoom").WaitingRoomDomain)(storage);
...
router.post("/waiting-rooms/", (req, resp) => {
  appointmentDomain.create(req.body);
  console.log(req.body);
  return computeResponse(resp, req.body.id);
